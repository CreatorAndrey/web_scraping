...
def get_snils(folder):
    ...
    z = 0
    for col in ws.iter_rows(min_row=2, min_col=30, max_col=max_col1, max_row=count):
        for cell in col:
            z += 1
            if z % 2 == 0:
                continue
...
def main_an(down, up, folder):
    ...
    try:
        ...
        # for col in ws.iter_cols(min_row=down, min_col=30, max_col=30, max_row=up):
        #     for cell in col:
        #         snils = cell.value
        #         if snils is None:
        #             continue
        #         # print(snils)
        #         dict_snils_range.append(snils)
